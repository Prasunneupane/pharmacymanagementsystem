...
BEGIN
    ...
    IF p_id > 0 THEN
        ...
        WHERE id = p_id;
    ELSE
        INSERT INTO users (name, username, email, password, email_verified_at, remember_token, user_type, phone, is_active, created_at, updated_at)
        VALUES (p_name, p_username, p_email, p_password, p_email_verified_at, p_remember_token, p_user_type, p_phone, p_is_active, NOW(), NOW());
    END IF;
END;
        ');
    }
